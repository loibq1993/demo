<div class="form-control mb-4 offset-1 col-11">
    <div class="label-form mb-1">
        <span>Answer *</span>
    </div>
    <div class="content-input">
        <textarea name="answer[value][]" class="w-100"></textarea>
    </div>
    <div class="label-form mb-1 mt-3">
        <span>Explanation for answer</span>
    </div>
    <div class="content-input">
        <textarea name="explanation" class="w-100"></textarea>
    </div>
    <div class="correct-field-true-false">
